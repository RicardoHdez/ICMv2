    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="../alumnos/alumnos.html" style="color: #FFFFFF; font-size: 20px;">Alumnos</a></li>
                <li><a href="../estadocuenta/estadocuenta.html" style="color: #FFFFFF; font-size: 20px;">Estado de cuenta</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <!--Iniciar Sesion-->
                <li><a href="#" style="color: #FFFFFF; font-size: 15px;" data-toggle="modal" data-target="#login">Iniciar sesion</a></li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
</nav>
        ...
        <div class="modal-body">
          <form action="../login.php" method="POST">
            <div class="form-group">
              ...
              <input type="text" class="form-control" aria-hidden="true" id="user" name="user" placeholder="Usuario" required/>
              <!--<i class="glyphicon glyphicon-knight form-control"></i>-->
            </div>
            <div class="form-group">
